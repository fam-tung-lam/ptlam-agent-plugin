---
name: ptlam-resolving-testing-environment
description:
  Resolve, evaluate, recommend, or apply one project's testing environment and
  toolchain. Use when the current environment is ambiguous, unverified,
  incompatible, missing, being replaced, or explicitly under review.
---
