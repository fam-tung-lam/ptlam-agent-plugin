...
description:
  ...
  or fixing OpenAPI and runtime failures. Do not use for Python services that do
  not use FastAPI.
---
...
typing, general async work, Pydantic, exception mechanics,
docstrings, logging, and pytest.
