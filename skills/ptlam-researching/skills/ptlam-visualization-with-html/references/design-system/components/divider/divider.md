...
individual row, and keep the rule visible but visually quiet. A vertical rule is
acceptable only when the adjacent regions remain related and reflow without it
on narrow screens.
