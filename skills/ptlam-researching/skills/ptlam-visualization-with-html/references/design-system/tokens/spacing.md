...
The scaffold owns the exact baseline values. Use the shared spacing scale to
express grouping, hierarchy, and touch safety; keep related controls closer than
unrelated regions and preserve whitespace around the current learning focus.
