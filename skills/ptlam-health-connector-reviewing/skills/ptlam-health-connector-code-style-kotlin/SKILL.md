...
description:
  ...
  fixing a Kotlin formatting, analysis, or test-convention failure. Compose this
  skill from any Health Connector workflow that changes Kotlin files. Do not use
  for Android architecture, Health Connect behavior, Pigeon ownership, or
  end-to-end handler registration.
---
