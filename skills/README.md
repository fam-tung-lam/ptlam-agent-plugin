...
flowchart LR
  ...
  skill_3["ptlam-code-style-flutter [public root]"]
  skill_4["ptlam-code-style-python [public root]"]
  skill_5["ptlam-code-style-python-fastapi [public root]"]
  skill_6["ptlam-code-style-typescript [public root]"]
  skill_7["ptlam-creating-skill [public root]"]
  skill_8["ptlam-grilling [public root]"]
  skill_9["ptlam-creating-prd [public root]"]
  skill_10["ptlam-creating-spec [public root]"]
  skill_11["ptlam-planning-tickets [public root]"]
  skill_12["ptlam-modeling-domain [public root]"]
  skill_13["ptlam-creating-adr [public root]"]
  skill_14["ptlam-creating-atomic-note [public root]"]
  skill_15["ptlam-scraping-urls [public root]"]
  skill_16["ptlam-explaining [public root]"]
  skill_17["ptlam-mermaiding [public root]"]
  skill_18["ptlam-visualization-with-html [public root]"]
  skill_3 --> skill_2
  skill_4 --> skill_2
  skill_5 --> skill_4
  skill_6 --> skill_2
