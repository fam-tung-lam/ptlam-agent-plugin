...
Read this when deciding where a new test file belongs and no higher-precedence
source answers it. It owns this foundation's fallback layout and the rules for
relocating a misplaced test.
