...
generated output. Never disable a rule project-wide to silence one call site. A
suppression with no reason gets deleted at the next review, because nobody can
