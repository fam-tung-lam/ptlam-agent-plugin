...
- Grouped authored skills under engineering, product-development, communication,
  productivity, and project directories while keeping `ptlam-creating-skill` at
  the authored root and generated installation paths flat.
