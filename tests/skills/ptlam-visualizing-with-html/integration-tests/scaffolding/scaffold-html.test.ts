...
import { runScaffoldHtmlCommand } from "../../../../../plugin/skills/productivity/ptlam-visualizing-with-html/scripts/scaffolding/scaffold-html.ts";
import {
  outputCapture,
...
const scaffoldScript = path.resolve(
  "plugin/skills/productivity/ptlam-visualizing-with-html/scripts/scaffolding/scaffold-html.ts",
);
