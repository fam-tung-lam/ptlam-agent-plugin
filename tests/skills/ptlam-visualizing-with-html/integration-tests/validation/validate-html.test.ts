...
import { runValidateHtmlCommand } from "../../../../../plugin/skills/productivity/ptlam-visualizing-with-html/scripts/validation/validate-html.ts";
import {
  outputCapture,
...
const validateScript = path.resolve(
  "plugin/skills/productivity/ptlam-visualizing-with-html/scripts/validation/validate-html.ts",
);
